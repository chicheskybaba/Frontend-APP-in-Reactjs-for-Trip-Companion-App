                            ...
                            <Card key={trip.id} className="mb-3">
                                <Card.Body>
                                    <div className={`${trip.completed ? "text-decoration-line-through" : ""}`}>
                                        ...
                                        <Card.Title><b>Participant 1:</b> {trip.spouse}</Card.Title>
                                        <Card.Title><b>Participant 2:</b> {trip.first_child}</Card.Title>
                                        <Card.Title><b>Participant 3:</b> {trip.second_child}</Card.Title>
                                        <Card.Title><b>Participant 4:</b> {trip.third_child}</Card.Title>
